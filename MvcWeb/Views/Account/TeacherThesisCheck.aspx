...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="server">
    ...
    <p style="margin-top:30px; margin-left:100px">
        <span style="font-size:30px; font-family:@隶书; color:Black; margin-left:50px">论文审阅结果</span>
    ...
    <% foreach (var item in Model.student) { %>
        ...
        <tr align="center" valign="middle">
            ...
            <% foreach (var item1 in Model.topic)
               { %>
               <% if (item.ID == item1.ID)
                  { %>
                <td>
            ...
            <%} }%>            
            <td>
                <%: Html.ActionLink("审阅结果", "CheckResultList", new { id = item.ID }) %> |
                <%: Html.ActionLink("修改", "CheckResultEdit", new { id = item.ID })%> 
            </td>
