<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/TeacherSite.Master" Inherits="System.Web.Mvc.ViewPage<MvcWeb.Models.MajorGrade>" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="server">

    <p style="margin-top:30px; margin-left:100px">
        <span style="font-size:30px; font-family:@隶书; color:Black; margin-left:50px">学生信息查询</span>
